...
import com.school.project.expensetracer.fragments.BGraphFragment;
import com.school.project.expensetracer.fragments.BReportFragment;
import com.school.project.expensetracer.fragments.CategoryFragment;
import com.school.project.expensetracer.fragments.TodayFragment;
    ...
    private void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
            ...
            case R.id.nav_report:
                loadFragment(BReportFragment.class, menuItem.getItemId(), menuItem.getTitle());
                break;

            case R.id.nav_graph:
                loadFragment(BGraphFragment.class, menuItem.getItemId(), menuItem.getTitle());
                break;
                //nav_graph
