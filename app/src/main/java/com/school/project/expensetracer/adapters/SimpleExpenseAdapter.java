package com.school.project.expensetracer.adapters;
...
public class SimpleExpenseAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String type = cursor.getString(cursor.getColumnIndexOrThrow(ExpensesContract.Expenses.TYPE)).toUpperCase();

        // Populate views with extracted values
        tvExpenseValue.setText(Utils.formatToCurrency(expValue));
        tvExpenseCatName.setText(categoryName+" ("+type+")");
